...
\begin{lstlisting}[language=TCL, caption={Volume rendering of a high potential iron protein.}, escapechar=\%]
...
vtkVolumeProperty%\index{vtkVolumeProperty!example}% volumeProperty
...
vtkVolumeRayCastCompositeFunction%\index{vtkVolumeRayCastCompositeFunction!example}% compositeFunction
vtkVolumeRayCastMapper%\index{vtkVolumeRayCastMapper!example}% volumeMapper
  volumeMapper SetVolumeRayCastFunction compositeFunction
  volumeMapper SetInputConnection [reader GetOutputPort]

#  Set the mapper and the property and
vtkVolume%\index{vtkVolume!example}% volume
...
To produce a maximum intensity projection in Figure \ref{fig:Figure7-34}, we would simply change the type of the ray function to a vtkVolumeRayCastMIPFunction\index{vtkVolumeRayCastMIPFunction!example}. We could also produce a surface image using a vtkVolumeRayCastIsosurfaceFunction\index{vtkVolumeRayCastIsosurfaceFunction!example} where the IsoValue instance variable would be set to define the surface.
...
\begin{lstlisting}[language=TCL, caption={An example of using vtkLineWidget to produce sreamlines.}, escapechar=\%]
vtkRungeKutta4 rk4
vtkPolyData seeds
...
vtkLineWidget%\index{vtkLineWidget!example}% lineWidget
