...
vtkTransform%\index{vtkTransform!example}% trSphere
  trSphere Identity
...
vtkTransformCollection%\index{vtkTransformCollection!example}% transforms
vtkTransform%\index{vtkTransform!example}% t1
  t1 Identity
vtkTransform t2
...
\begin{figure}[htb]
	...
	\begin{subfigure}[h]{0.76\linewidth}
        ...
        vtkTexture%\index{vtkTexture!example}% texture
