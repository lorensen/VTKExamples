...
These images come from a variety of medical imaging devices, including X--ray, X--ray Computed Tomography\index{Computed Tomography}\index{CT|see {Computed Tomography}}), Magnetic Resonance Imaging (MRI), and ultrasound. Each imaging technique, called an imaging modality, has particular diagnostic strengths.
...
\index{applications!segmented volume data|(}
...
\index{applications!financial visualization|(}\index{financial visualization!application|(}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\textwidth]{Figure12-10}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\textwidth]{Figure12-11}
...
\index{applications!financial visualization|)}

\section{Implicit Modelling}
\index{applications!implicit modelling|(}\index{C++!application|(}\index{financial visualization!application|)}
...
\index{applications!implicit modelling|)}\index{C++!application|)}

\section{Computational Fluid Dynamics}
\index{applications!computational fluid dynamics|(}\index{computational fluid dynamics!application|(}
\index{finite difference method!application}
...
To display the scalar field using color mapping\index{color mapping!application}, we must change the
...
\index{algorithm visualization!application|)}
\index{applications!algorithm visualization|)}
\index{applications|)}
