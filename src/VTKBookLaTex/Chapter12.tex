...
We seed the field with multiple starting points (using points arranged along a curve, referred to as a *rake*) and experiment with parameters for the streamlines.
...
page \pageref{sec:3dwui}). As we saw in ``Point Probe'' on page \pageref{subsec:point_probe}, probing the data
...
directories. Similar approaches can be used to visualize stacks, queues, linked lists, trees, and other data structures.

\begin{figure}[!h]
	\begin{subfigure}[h]{0.96\linewidth}
		\includegraphics[width=0.86\linewidth]{Figure12-20a}
	...
	\hfill
	\begin{subfigure}[h]{0.96\linewidth}
		\includegraphics[width=0.86\linewidth]{Figure12-20b}
	...
	\hfill
	\begin{subfigure}[h]{0.96\linewidth}
		\includegraphics[width=0.86\linewidth]{Figure12-20c}
...
recursion. We have shown portions of the C++ code below.
