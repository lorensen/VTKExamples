...
%\clearpage
    ...
    \item[Line.\index{interpolation function!line}] Figure \ref{fig:Figure8-3} shows the parametric coordinate system and interpolation functions for a line.The line is described using the single parametric coordinate $r$.
...
\index{cell!intersection with line|(}\index{cell / line!intersection|(}
