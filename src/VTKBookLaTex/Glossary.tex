...
\newglossaryentry{Object--Order Techniques}{
    ...
    description={\index{object--order rendering}Rendering techniques that project object data (e.g., polygons or voxels) onto the image plane. Example techniques include ordered compositing and splatting}}
