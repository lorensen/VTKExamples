...
\newglossaryentry{Event--driven}{
    name=Event--driven,
    description={\index{event--driven execution}A method of visualization pipeline update where updates occur when an event  affects the pipeline\index{execution!pipeline}, e.g., when an object instance variable is set or modified. See also \emph{demand--driven}}}
...
\newglossaryentry{Explicit Execution}{
    ...
    description={\index{execution!explicit}\index{explicit control}Controlling network updates by performing explicit dependency analysis}}
...
\newglossaryentry{Particle Trace}{
    name=Particle Trace,
    description={The trajectory that particles trace over time in fluid flow. Particle traces are everywhere tangent to the velocity field. Unlike streamlines, particle lines are time--dependent}}
