...
\newglossaryentry{Phong Shading}{
    name=Phong Shading,
    description={\index{Phong shading}A shading technique that applies the lighting equations for a geometric primitive at each pixel. See also \emph{flat shading} and \emph{Gouraud shading}}}
