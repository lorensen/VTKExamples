...
\newglossaryentry{Mapper}{
    name=Mapper,
    description={\index{mapper}\index{mapper object}A process object that terminates the visualization network. It maps input data into graphics libraries (or other devices) or writes data to disk (or a communication device)}}
...
\newglossaryentry{Writer}{
    name=Writer,
    description={\index{mapper!writer}\index{mapper object!writer}A type of mapper object that writes data to disk or other I/O device}}
