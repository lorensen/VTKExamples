...
\item 	 Using the filters vtkStreamLine, vtkMaskPoints, and vtkGlyph3D\index{vtkGlyph3D!exercise}, create a visualization consisting of oriented glyphs along a streamline.
