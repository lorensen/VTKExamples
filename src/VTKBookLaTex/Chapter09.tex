...
\index{modelling algorithms!probing|(}
...
\index{modelling algorithms!normal generation|(}\index{normal generation!polygon|(}
...
\index{modelling algorithms!mesh smoothing|(}
...
\index{modelling algorithms!swept surface|(}
...
\index{modelling algorithms!unstructured points!splatting|(}
