...
\index{image processing algorithms!non--linear smoothing|(}
...
\index{image processing algorithms!segmentation|(}\index{image segmentation|(}
...
A simple example of a one-parameter segmentation is a threshold filter\index{image segmentation!threshold filter} used to mark bone in a CT dataset. Since bone has the largest scalar value, it is easy to select a threshold that separates bone from the rest of the image.
...
\index{image processing algorithms!postprocessing|(}
...
\index{image processing algorithms!multi--spectral segmentation|(}
