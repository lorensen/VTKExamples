...
We did add code to link figure references to the figures. We used a set of [standard templates](https://github.com/lorensen/VTKExamples/blob/master/src/VTKBook/Figures/FigureTemplates.txt) to caption the figures. We also link all references to VTK classes to their Doxygen documentation.
