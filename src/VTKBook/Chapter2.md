...
Earlier we created an object corresponding to a pin oak tree. The properties of the tree can be more thoroughly described using inheritance ( **Figure2-2** ). The classification shown here is based on the five kingdom system of Margulis and Schwartz
...
<figure id="Figure2-4">
  <img src="https://raw.githubusercontent.com/lorensen/VTKExamples/master/src/VTKBook/Figures/Figure2-4.png?raw=true width="640" alt="Figure2-4">
</figure>
