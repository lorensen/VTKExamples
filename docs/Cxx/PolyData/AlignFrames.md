[VTKExamples](/index/)/[Cxx](/Cxx)/PolyData/AlignFrames
...
Click [here to download AlignFrames](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/AlignFrames.tar) and its *CMakeLists.txt* file.
Once the *tarball AlignFrames.tar* has been downloaded and extracted,
```
