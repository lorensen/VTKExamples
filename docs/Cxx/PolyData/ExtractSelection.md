[VTKExamples](/index/)/[Cxx](/Cxx)/PolyData/ExtractSelection
...
target_link_libraries(ExtractSelection ${VTK_LIBRARIES})
```

**Download and Build ExtractSelection**

Click [here to download ExtractSelection](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/ExtractSelection.tar) and its *CMakeLists.txt* file.
Once the *tarball ExtractSelection.tar* has been downloaded and extracted,
```
