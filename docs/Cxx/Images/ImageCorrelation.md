[VTKExamples](/index/)/[Cxx](/Cxx)/Images/ImageCorrelation
...
target_link_libraries(ImageCorrelation ${VTK_LIBRARIES})
```

**Download and Build ImageCorrelation**

Click [here to download ImageCorrelation](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/ImageCorrelation.tar) and its *CMakeLists.txt* file.
Once the *tarball ImageCorrelation.tar* has been downloaded and extracted,
```
