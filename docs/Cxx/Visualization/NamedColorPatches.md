[VTKExamples](/index/)/[Cxx](/Cxx)/Visualization/NamedColorPatches
...
target_link_libraries(NamedColorPatches ${VTK_LIBRARIES})
```

**Download and Build NamedColorPatches**

Click [here to download NamedColorPatches](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/NamedColorPatches.tar) and its *CMakeLists.txt* file.
Once the *tarball NamedColorPatches.tar* has been downloaded and extracted,
```
