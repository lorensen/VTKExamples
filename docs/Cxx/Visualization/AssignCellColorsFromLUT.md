...
target_link_libraries(AssignCellColorsFromLUT ${VTK_LIBRARIES})
```

**Download and Build AssignCellColorsFromLUT**

Click [here to download AssignCellColorsFromLUT](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/AssignCellColorsFromLUT.tar) and its *CMakeLists.txt* file.
Once the *tarball AssignCellColorsFromLUT.tar* has been downloaded and extracted,
```
