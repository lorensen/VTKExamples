[VTKExamples](/index/)/[Cxx](/Cxx)/DataStructures/OBBTreeTimingDemo
...
target_link_libraries(OBBTreeTimingDemo ${VTK_LIBRARIES})
```

**Download and Build OBBTreeTimingDemo**

Click [here to download OBBTreeTimingDemo](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/OBBTreeTimingDemo.tar) and its *CMakeLists.txt* file.
Once the *tarball OBBTreeTimingDemo.tar* has been downloaded and extracted,
```
