[VTKExamples](/index/)/[Cxx](/Cxx)/Utilities/LUTUtilities
...
target_link_libraries(LUTUtilities ${VTK_LIBRARIES})
```

**Download and Build LUTUtilities**

Click [here to download LUTUtilities](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/LUTUtilities.tar) and its *CMakeLists.txt* file.
Once the *tarball LUTUtilities.tar* has been downloaded and extracted,
```
