...
Click [here to download BackgroundTexture](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/BackgroundTexture.tar) and its *CMakeLists.txt* file.
Once the *tarball BackgroundTexture.tar* has been downloaded and extracted,
```
