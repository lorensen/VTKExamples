...
<img align="right" src="https://github.com/lorensen/VTKExamples/raw/master/Testing/Baseline/Visualization/TestKochSnowflake.png" width="256" />
...
target_link_libraries(KochSnowflake ${VTK_LIBRARIES})
```

**Download and Build KochSnowflake**

Click [here to download KochSnowflake](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/KochSnowflake.tar) and its *CMakeLists.txt* file.
Once the *tarball KochSnowflake.tar* has been downloaded and extracted,
```
