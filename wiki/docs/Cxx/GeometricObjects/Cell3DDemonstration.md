...
target_link_libraries(Cell3DDemonstration ${VTK_LIBRARIES})
```

**Download and Build Cell3DDemonstration**

Click [here to download Cell3DDemonstration](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/Cell3DDemonstration.tar) and its *CMakeLists.txt* file.
Once the *tarball Cell3DDemonstration.tar* has been downloaded and extracted,
```
