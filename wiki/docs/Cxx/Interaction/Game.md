...
<img align="right" src="https://github.com/lorensen/VTKExamples/raw/master/Testing/Baseline/Interaction/TestGame.png" width="256" />
...
target_link_libraries(Game ${VTK_LIBRARIES})
```

**Download and Build Game**

Click [here to download Game](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/Game.tar) and its *CMakeLists.txt* file.
Once the *tarball Game.tar* has been downloaded and extracted,
```
cd Game/build 
```
If VTK is installed:
