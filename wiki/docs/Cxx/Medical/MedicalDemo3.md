[VTKExamples](/index/)/[Cxx](/Cxx)/Medical/MedicalDemo3

<img align="right" src="https://github.com/lorensen/VTKExamples/blob/gh-pages/Testing/Baseline/Medical/TestMedicalDemo3.png?raw=true" width="256" />
...
target_link_libraries(MedicalDemo3 ${VTK_LIBRARIES})
```

**Download and Build MedicalDemo3**

Click [here to download MedicalDemo3](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/MedicalDemo3.tar) and its *CMakeLists.txt* file.
Once the *tarball MedicalDemo3.tar* has been downloaded and extracted,
```
