[VTKExamples](/index/)/[Cxx](/Cxx)/Images/Gradient
...
Click [here to download Gradient](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/Gradient.tar) and its *CMakeLists.txt* file.
Once the *tarball Gradient.tar* has been downloaded and extracted,
```
cd Gradient/build 
```
If VTK is installed:
