...
<img align="right" src="https://github.com/lorensen/VTKExamples/raw/master/Testing/Baseline/Images/TestPickPixel2.png" width="256" />
...
target_link_libraries(PickPixel2 ${VTK_LIBRARIES})
```

**Download and Build PickPixel2**

Click [here to download PickPixel2](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/PickPixel2.tar) and its *CMakeLists.txt* file.
Once the *tarball PickPixel2.tar* has been downloaded and extracted,
```
cd PickPixel2/build 
```
If VTK is installed:
