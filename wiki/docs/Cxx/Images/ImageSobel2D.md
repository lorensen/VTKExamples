[VTKExamples](/index/)/[Cxx](/Cxx)/Images/ImageSobel2D
...
target_link_libraries(ImageSobel2D ${VTK_LIBRARIES})
```

**Download and Build ImageSobel2D**

Click [here to download ImageSobel2D](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/ImageSobel2D.tar) and its *CMakeLists.txt* file.
Once the *tarball ImageSobel2D.tar* has been downloaded and extracted,
```
