...
Click [here to download SignedDistance](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/SignedDistance.tar) and its *CMakeLists.txt* file.
Once the *tarball SignedDistance.tar* has been downloaded and extracted,
```
