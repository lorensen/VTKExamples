[VTKExamples](/index/)/[Cxx](/Cxx)/Rendering/DiffuseSpheres

<img align="right" src="https://github.com/lorensen/VTKExamples/blob/gh-pages/Testing/Baseline/Rendering/TestDiffuseSpheres.png?raw=true" width="256" />
...
target_link_libraries(DiffuseSpheres ${VTK_LIBRARIES})
```

**Download and Build DiffuseSpheres**

Click [here to download DiffuseSpheres](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/DiffuseSpheres.tar) and its *CMakeLists.txt* file.
Once the *tarball DiffuseSpheres.tar* has been downloaded and extracted,
```
