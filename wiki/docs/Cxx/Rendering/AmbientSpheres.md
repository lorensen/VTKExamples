...
target_link_libraries(AmbientSpheres ${VTK_LIBRARIES})
```

**Download and Build AmbientSpheres**

Click [here to download AmbientSpheres](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/AmbientSpheres.tar) and its *CMakeLists.txt* file.
Once the *tarball AmbientSpheres.tar* has been downloaded and extracted,
```
