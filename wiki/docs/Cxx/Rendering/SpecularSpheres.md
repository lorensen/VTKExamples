...
<img align="right" src="https://github.com/lorensen/VTKExamples/raw/master/Testing/Baseline/Rendering/TestSpecularSpheres.png" width="256" />
...
Click [here to download SpecularSpheres](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/SpecularSpheres.tar) and its *CMakeLists.txt* file.
Once the *tarball SpecularSpheres.tar* has been downloaded and extracted,
```
