...
Click [here to download AnimationScene](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/AnimationScene.tar) and its *CMakeLists.txt* file.
Once the *tarball AnimationScene.tar* has been downloaded and extracted,
```
