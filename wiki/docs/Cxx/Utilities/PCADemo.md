[VTKExamples](/index/)/[Cxx](/Cxx)/Utilities/PCADemo
...
target_link_libraries(PCADemo ${VTK_LIBRARIES})
```

**Download and Build PCADemo**

Click [here to download PCADemo](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/PCADemo.tar) and its *CMakeLists.txt* file.
Once the *tarball PCADemo.tar* has been downloaded and extracted,
```
cd PCADemo/build 
```
If VTK is installed:
