[VTKExamples](/index/)/[Cxx](/Cxx)/PolyData/InterpolateMeshOnGrid
...
Click [here to download InterpolateMeshOnGrid](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/InterpolateMeshOnGrid.tar) and its *CMakeLists.txt* file.
