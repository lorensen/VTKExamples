...
target_link_libraries(ExtractSelectedIds ${VTK_LIBRARIES})
```

**Download and Build ExtractSelectedIds**

Click [here to download ExtractSelectedIds](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/ExtractSelectedIds.tar) and its *CMakeLists.txt* file.
Once the *tarball ExtractSelectedIds.tar* has been downloaded and extracted,
```
cd ExtractSelectedIds/build 
```
If VTK is installed:
```
cmake ..
