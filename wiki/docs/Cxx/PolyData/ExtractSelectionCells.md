[VTKExamples](Home)/[Cxx](Cxx)/PolyData/ExtractSelectionCells

<img align="right" src="https://github.com/lorensen/VTKExamples/raw/master/Testing/Baseline/PolyData/TestExtractSelectionCells.png" width="256" />
...
target_link_libraries(ExtractSelectionCells ${VTK_LIBRARIES})
```

**Download and Build ExtractSelectionCells**

Click [here to download ExtractSelectionCells](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/ExtractSelectionCells.tar) and its *CMakeLists.txt* file.
Once the *tarball ExtractSelectionCells.tar* has been downloaded and extracted,
```
