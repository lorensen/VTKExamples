...
<img align="right" src="https://github.com/lorensen/VTKExamples/raw/master/Testing/Baseline/PolyData/TestImplicitDataSetClipping.png" width="256" />
...
target_link_libraries(ImplicitDataSetClipping ${VTK_LIBRARIES})
```

**Download and Build ImplicitDataSetClipping**

Click [here to download ImplicitDataSetClipping](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/ImplicitDataSetClipping.tar) and its *CMakeLists.txt* file.
Once the *tarball ImplicitDataSetClipping.tar* has been downloaded and extracted,
```
