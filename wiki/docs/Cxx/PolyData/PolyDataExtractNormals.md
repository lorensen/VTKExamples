...
Click [here to download PolyDataExtractNormals](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/PolyDataExtractNormals.tar) and its *CMakeLists.txt* file.
