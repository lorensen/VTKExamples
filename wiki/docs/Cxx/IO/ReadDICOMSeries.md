[VTKExamples](/index/)/[Cxx](/Cxx)/IO/ReadDICOMSeries
...
Click [here to download ReadDICOMSeries](https://github.com/lorensen/VTKWikiExamplesTarballs/raw/master/ReadDICOMSeries.tar) and its *CMakeLists.txt* file.
Once the *tarball ReadDICOMSeries.tar* has been downloaded and extracted,
```
